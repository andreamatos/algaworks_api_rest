...
public class LancamentoResource {
	...
	//localhost:8080/lancamentos?resumo - passando como parametro "resumo"
	//localhost:8080/lancamentos?resumo&descricao=Salário - com filtro 
	...
	//Não retorna mais o list, retorna qual é a pagina e a quantidade de registros na pagina
	@GetMapping
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO') and #oauth2.hasScope('read')")
